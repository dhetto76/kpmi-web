      ...
      <div className="shell grid gap-10 py-14 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            {NAV.map((n) => (
              <li key={n.href}>
                <Link to={n.href} className="transition-colors hover:text-gold-300">
                  {n.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/daftar" className="transition-colors hover:text-gold-300">
                Daftar Anggota
              </Link>
            </li>
            <li>
              <Link to="/masuk" className="transition-colors hover:text-gold-300">
                Masuk
              </Link>
            </li>
            <li>
              <Link to="/bisnis" className="transition-colors hover:text-gold-300">
                Direktori Bisnis
              </Link>
            </li>
            <li>
              <Link to="/produk" className="transition-colors hover:text-gold-300">
                Katalog Produk
              </Link>
            </li>
            <li>
              <Link to="/berita" className="transition-colors hover:text-gold-300">
                Berita &amp; Acara
              </Link>
            </li>
          </ul>
