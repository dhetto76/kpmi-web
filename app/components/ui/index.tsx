...
/**
 * Keeps the `href` prop the Next.js version took, so call sites did not change.
 *
 * An absolute URL renders a plain anchor: React Router's Link is for in-app
 * navigation and would try to client-route an external address.
 */
...
/** True for absolute URLs, protocol-relative URLs, and mailto:/tel:. */
